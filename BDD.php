...
class BDD {
	...
	private $stmt; // La connexion spécifique pour les requêtes préparées
	
	public function __construct($base = "form_bdd", $serveur = "localhost", $user = "root", $mdp = "")
	{
		...
		$this->stmt = mysqli_stmt_init($this->connexion);
